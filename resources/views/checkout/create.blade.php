                    ...
                    <div class="col-lg-6 col-12">
                        <form action="{{ route('checkout.store', $camp->id) }}" class="basic-form" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input name="occupation" type="text" class="form-control {{ $errors->has('occupations') ? 'is-invalid' : ''}}" value="{{old('occupation') ?: Auth::user()->occupation}}" required/>
                            ...
                            <div class="mb-5">
                                <div class="row"> 
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        <input name="cvc" type="text" class="form-control {{ $errors->has('cvc') ? 'is-invalid' : ''}}" maxlength="5" value="{{ old('cvc') ?: '' }}" required/>
                                        @if ($errors->has('cvc'))
